...
func (in *Dataset) DeepCopyInto(out *Dataset) {
	*out = *in
	...
	if in.FederatorConnection != nil {
		in, out := &in.FederatorConnection, &out.FederatorConnection
...
func (in *ExperimentSpec) DeepCopyInto(out *ExperimentSpec) {
	*out = *in
	if in.FederatorSpec != nil {
		in, out := &in.FederatorSpec, &out.FederatorSpec
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FederationTemplateList) DeepCopyInto(out *FederationTemplateList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]FederatorTemplate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FederationTemplateList.
func (in *FederationTemplateList) DeepCopy() *FederationTemplateList {
	if in == nil {
		return nil
	}
	out := new(FederationTemplateList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *FederationTemplateList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *FederatorTemplate) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
func (in *NetworkConnection) DeepCopyInto(out *NetworkConnection) {
	*out = *in
	...
	in.DelayInjection.DeepCopyInto(&out.DelayInjection)
	return
}
