...
// Reconcile reads that state of the cluster for a KobeFederator object and
// makes changes based on the state read and what is in the KobeFederator.Spec
//
// TODO(user): Modify this Reconcile function to implement your Controller
// logic.  This example creates a Pod as an example Note: The Controller will
// requeue the Request to be processed again if the returned error is non-nil or
...
func (r *ReconcileKobeFederator) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Loop went through the end for reconciling kobefederator")
	return reconcile.Result{}, nil
}
