...
public interface TripleSource {
	...
	/**
	 * Check if the repository can return results for the given prepared
	 * ASK query
	 * 
	 * @param conn
	 * @param subj
	 ...
	 * @throws RepositoryException
	 */
	public boolean hasStatements(String preparedAskQuery, RepositoryConnection conn, BindingSet bindings) throws RepositoryException, MalformedQueryException, QueryEvaluationException;
