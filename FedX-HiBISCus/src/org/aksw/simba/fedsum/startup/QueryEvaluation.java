...
public static void main(String[] args) throws Exception 
	...
	String FedSummaries = "/home/antonis/fao-summaries-new.n3";
	
	String mode = "Index_dominant";  //{ASK_dominant, Index_dominant}
	double commonPredThreshold = 1 ;  //considered a predicate as common predicate if it is presenet in 33% available data sources
...
+ "}";
		String fao1 = "PREFIX dct: <http://purl.org/dc/terms/> " +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> " +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE { " +
				"  <http://agris.fao.org/aos/records/CN2012002999> dct:subject ?o . " +
				"  ?s dct:subject ?o . " +
		...
		String fao2 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
		...
		String fao3 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/CZ7500079> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao4 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/RS2008001806> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao5 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/PH2007001544> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao6 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/US201400064391> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao7 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/US201400129023> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao8 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/US201400102588> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao9 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/US201400030049> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao10 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/US201400010343> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao11 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/US201400176736> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao12 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/US201400039413> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao13 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/US201400106187> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao14 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/QB2015104203> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao15 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/JP2009004805> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao16 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/JP2009000291> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao17 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/KR2009001021> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao18 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/US201400093894> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao19 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/US201400167965> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
		...
		String fao20 = "PREFIX dct: <http://purl.org/dc/terms/>" +
				"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>" +
				"SELECT distinct ?s (COUNT(?o) as ?NELEMENTS) WHERE {" +
				"  <http://agris.fao.org/aos/records/US201400079118> dct:subject ?o ." +
				"  ?s dct:subject ?o ." +
				"  ?s rdf:type <http://semagrow.eu/rdf#CrawledDocument> ." +
				"}" +
				"GROUP BY ?s " +
				"ORDER BY DESC(?NELEMENTS) " +
				"LIMIT 20";
		String test ="PREFIX dct: <http://purl.org/dc/terms/> SELECT * WHERE { ?s dct:subject ?o. ?s dct:title ?o2 } LIMIT 20";
	
	  bw= new BufferedWriter(new FileWriter("fedx_fedsum_results.txt",true));
      DNFgrps =  BGPGroupGenerator.generateBgpGroups(fao1);  // The time for DNF/bgp group generation is only around 3msec
	  TupleQuery tplQuery = repo.getConnection().prepareTupleQuery(QueryLanguage.SPARQL, fao1);
