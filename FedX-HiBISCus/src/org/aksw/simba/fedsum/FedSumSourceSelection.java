 ...
 *
 */
public class FedSumSourceSelection {
	...
	/**
	 * Perform triple pattern-wise source selection for the provided statement patterns of a SPARQL query using FedSummaries, cache or remote ASK queries.
	 ...
	 * @param stmts List of statement patterns
	...
	protected static class ParallelCheckTask implements ParallelTask<BindingSet> {
		...
		public CloseableIteration<BindingSet, QueryEvaluationException> performTask() throws Exception {
			try {
				...
				FedSumSourceSelection sourceSelection = control.sourceSelection;
